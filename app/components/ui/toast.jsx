...
const ToastAction = React.forwardRef(({ className, ...props }, ref) => (
  <ToastPrimitives.Action
    ref={ref}
    className={cn(
      'inline-flex h-8 shrink-0 items-center justify-center rounded-md border-2 border-gray-300 bg-transparent px-3 text-sm font-medium text-gray-700 transition-colors',
      'hover:bg-gray-100',
      'focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2',
      'disabled:pointer-events-none disabled:opacity-50',
      'group-[.destructive]:border-white/40 group-[.destructive]:text-white',
      'group-[.destructive]:hover:border-white/60 group-[.destructive]:hover:bg-white/10',
